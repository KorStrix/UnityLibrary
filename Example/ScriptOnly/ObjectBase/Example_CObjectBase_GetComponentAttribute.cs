...
namespace StrixLibrary_Example
{
    ...
    public class Example_CObjectBase_GetComponentAttribute : CObjectBase, IInterfaceTest_A
    {
...
#endif
        [GetComponent]
        public IInterfaceTest_A pInterface_Me;
        ...
        public IInterfaceTest_A pInterface_Child;
...
#endif
        [GetComponentInChildren]
        public Dictionary<string, IInterfaceTest_A> Dictionary_Key_IsString_Value_IsInterface;
